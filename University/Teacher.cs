...
namespace University
{
    ...
    class Teacher : Human
    {
        ...
        public Teacher(string name, string surname, int age, bool habbits, Gender gender, Nation nation, Adress adress, string email, int salary, string department, int numofseats, KeyWords keywords) : base(name, surname,
